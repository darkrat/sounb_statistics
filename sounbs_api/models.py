...
class Event(models.Model):
    EventType = models.OneToOneField('EventType', on_delete=models.CASCADE, related_name = 'EventType',  verbose_name='Тип мероприятия',help_text='Массовое мероприятие')
    Department = models.OneToOneField('Department', on_delete=models.CASCADE, related_name = 'Department', verbose_name='Отдел-организатор',help_text='Выберите из списка')
    EventForm = models.OneToOneField('EventForm', on_delete=models.CASCADE, related_name = 'EventForm', verbose_name='',help_text='Выберите из списка')
    Owner = models.OneToOneField(get_user_model(), related_name = 'Owner', on_delete=models.CASCADE, verbose_name='Оператор')
    Theme = models.OneToOneField('Theme', on_delete=models.CASCADE, related_name = 'Theme', verbose_name='Тема мероприятия',help_text='Выберите из списка')
